    ...
    >
      ...
      <div className="w-full flex mt-8 justify-around px-2">
        ...
        <div className="text-center">
          <div className="text-black font-fira-sans text-[8.432px] font-medium tracking-[2.409px] uppercase mb-1 text-left">
            <Link to="/" className="mt-2 block cursor-pointer">
              Home
            </Link>
          </div>
          <div className="mt-4 text-black font-fira-sans text-[10.841px] font-normal leading-[16.864px] text-left">
            <Link to="/nosotros" className="mt-2 block cursor-pointer">
              Nosotros
            </Link>
            <Link to="/projects" className="mt-2 block cursor-pointer">
              Proyectos
            </Link>
            <Link to="/medio-ambiente" className="mt-2 block cursor-pointer">
              Medio Ambiente
            </Link>
          </div>
        </div>
        ...
        {/* Column 3: Contacto */}
        <div className="text-center">
          <div className="text-black font-fira-sans text-[8.432px] font-medium tracking-[2.409px] uppercase mb-1">
