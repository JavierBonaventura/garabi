  ...
  return (
    <div>
      <div className="w-full h-auto">
        ...
        >
         <div
  className="absolute z-30 w-[40vw] h-[24%] -top-[3%] left-[56%] origin-top-left"
  style={{
    background:
...
/>
          ...
          >
            <div className="grid grid-cols-2 gap-8 w-full max-w-[1200px]">
              ...
              <h1
  className="w-[471.305px] text-black font-fira-sans text-[60px] font-bold leading-[50px] mt-[50px]"
>
  Nuestra historia
</h1>
...
<p
  className="w-[460.714px] text-black font-fira-sans text-[24px] font-normal leading-[28px] mt-[50px]"
>
  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam interdum erat
  nec commodo imperdiet. Duis libero nisi, mollis quis urna ornare, feugiat
  egestas nunc.
</p>

<button
  className="w-[245.25px] h-[50px] bg-[#00942C] rounded-[5px] mt-[50px] flex justify-center items-center cursor-pointer transition-transform duration-500 ease-out hover:bg-[#007A24] hover:-translate-y-0.5"
>
  <div className="z-30 w-[245.25px] h-[16px] flex flex-col justify-center">
    <span
      className="text-white text-center font-fira-sans text-[14px] font-normal uppercase tracking-[4px]"
    >
      Ver video
    </span>
  </div>
