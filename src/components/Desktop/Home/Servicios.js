        ...
        >
          <div>
            ...
            <div className="flex justify-center mt-[80px] space-x-[30px]">
              {/* Primer rectángulo */}
              <div className="relative w-[527px] h-[474px] flex-shrink-0 rounded-[21.323px] bg-[#DAD8CB] shadow-[13.327px_13.327px_23.322px_6.663px_rgba(2,2,2,0.30)] ">
                ...
                <div className="text-[#464646] text-center  text-[24px] font-normal leading-[23px] tracking-[-1.333px] absolute top-[270px] left-1/2 transform -translate-x-1/2 w-[452.381px] h-[62.274px]">
                ...
                <a
                  href="/servicios"
                  className="w-[217px] h-[50px] rounded-[5px]  absolute top-[392px] left-1/2  flex justify-center items-center bg-[#00942C] cursor-pointer transition-transform duration-500 ease-out hover:bg-[#007A24] hover:-translate-y-0.5 transform translate-x-[-50%]"
                >
